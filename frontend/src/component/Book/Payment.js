...
const Payment = ({ history }) => {
  ...
  const appointment = {
    addressInfo:appointingInfo,
    appointedEmployees: bookWorkers,
      ...
      const result = await stripe.confirmCardPayment(client_secret, {
        payment_method: {
          ...
          billing_details: {
            ...
            email: user.email,
            address: {
              line1: appointingInfo.address,
              city: appointingInfo.city,
              state: appointingInfo.state,
              postal_code: appointingInfo.pinCode,
              country: appointingInfo.country,
            },
          },
        },
      });
 ...
 /*
  ...
  const order = {
    appointingInfo,
    bookworkers: bookWorkers,
    itemsPrice: appointmentInfo.subtotal,
    taxPrice: appointmentInfo.tax,
    appointingPrice: appointmentInfo.appointingCharges,
    totalPrice: appointmentInfo.totalPrice,
  };
